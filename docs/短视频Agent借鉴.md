...
| [longmao-001/kesheng_skill](https://github.com/longmao-001/kesheng_skill)（多 agent 视频团队） | 判型先行：口播稿＝文案/信息驱动 与剧本＝戏剧动作驱动 的通道区分 | `fuben-write/SKILL.md` 的“写的是口播逐字稿不是小说”定位 |
