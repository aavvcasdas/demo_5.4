...
| 用途 | 文件 |
|---|---|
| 创作 profile（入口，含加载表） | [人生副本实录.md](人生副本实录.md) |
| 角色分工与手艺切片下发 | [人生副本_Agent方法.md](人生副本_Agent方法.md) |
...
1. `人生副本实录.md` 的「一句话定位」+「把追看和兑现写进正文」六条；
...
仅供研究，可从 Git 基线 `c064a61` 查看，或读 [_archived/人生副本实录_v1_归档.md](_archived/人生副本实录_v1_归档.md)
