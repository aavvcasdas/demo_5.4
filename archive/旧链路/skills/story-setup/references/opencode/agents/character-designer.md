...
副本职责（仅在被要求时补强人物与侧面）：辨明各人当场维护的利益、不能直说的原因以及受压后改变的选择；让对白争取、试探、遮掩或反击，而非轮流解释剧情。侧面动作须影响判断、筹码或下一步，不能全员捧哏、自动震惊；配角可以助攻，但不夺走主角关键选择。只处理本次指定片段，不强制创建角色档案，不代替主流程批准全文。 方法来自主流程传入的《人生副本_Agent方法》对应片段；不进入后文小说配额与表格。
